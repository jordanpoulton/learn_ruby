# You can use 'let' to create variables in RSpec:

# let(:car){ variable_setting }

# this will create a variable 'car', and it will be set to whatever you put into the block that follows it

# you can then use car anywhere in the file, which will DRY out your code.

# Further Reading: https://relishapp.com/rspec/rspec-core/v/3-2/docs/helper-methods/let-and-let
